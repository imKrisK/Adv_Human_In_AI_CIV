...
| P13-07 | In Progress | Extract first session-service runtime skeleton. | A deployed service boundary handles health checks and one validated session job path. |
