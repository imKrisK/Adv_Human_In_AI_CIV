    ...
    return (
      <div className="main-shell py-16">
        <div className="glass-panel mx-auto max-w-2xl rounded-[2rem] p-8">
          ...
          <h1 className="mt-4 text-3xl font-semibold">Hosted sign-in is not configured for this runtime.</h1>
          <p className="muted-copy mt-4 text-sm leading-7">
            The command deck is still using the local prototype auth path. Provision the Clerk keys and sign-in routes before using this surface.
          </p>
          <Link
            href="/command-deck"
    ...
    <div className="main-shell py-16">
      <div className="mx-auto flex max-w-4xl flex-col gap-8 lg:flex-row lg:items-start">
        <div className="glass-panel max-w-xl rounded-[2rem] p-8 lg:flex-1">
          ...
          <h1 className="mt-4 text-3xl font-semibold">Resume the bonded operator through Clerk.</h1>
          <p className="muted-copy mt-4 text-sm leading-7">
            After authentication, the callback will sync the Clerk user into the prototype persistence layer and return to the command deck.
          </p>
        </div>
        <div className="glass-panel rounded-[2rem] p-6 lg:min-w-[24rem]">
          <SignIn
            path="/sign-in"
            routing="path"
            signUpUrl={identityStrategy.signUpUrl ?? "/sign-up"}
